...
public class Hangman {
    //Declare variables
    static boolean wantToPlay = true;
    static boolean haveIWon;
    ...
    static String guess;
    static String[] wordList = {"ART"};
    static String[] wordList2 = {"ART", "BAR", "BAT", "BAN", "BIN", "BIT", "CAT", "DAD", "EAT", "EAR", "FUR", "FIT", "FAR",
    ...
    public static void endGame () {
        ...
        public static boolean noToPlay () {
            ...
            return Objects.equals(choiceToPlay, "N") || Objects.equals(choiceToPlay, "n");
        }
